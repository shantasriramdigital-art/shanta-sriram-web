          ...
          <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 24px' }}>
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <a
                    href={`https://wa.me/919849955887?text=${encodeURIComponent(`Hi, I am interested in ${project.name}${project.location ? ' at ' + project.location : ''}. Please share pricing and availability details.`)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', backgroundColor: '#25D366', color: 'white', padding: '12px 24px', borderRadius: '4px', textDecoration: 'none', fontSize: '13px', fontWeight: 500, letterSpacing: '0.05em' }}
                  >
