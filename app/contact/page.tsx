...
export default function ContactPage() {
  const contactMethods = [
    { icon: Phone, title: 'Phone', value: BRAND.phone, href: 'tel:+914045656500' },
    { icon: Mail, title: 'Email', value: BRAND.email, href: `mailto:${BRAND.email}` },
    { icon: MapPin, title: 'Address', value: 'Gachibowli, Hyderabad', href: 'https://maps.google.com/?q=Shalom+Skycity+Gachibowli+Hyderabad+500032' },
  ];

  const faqs = [
    { q: 'What is the minimum investment required?', a: 'The minimum investment varies by project. Please check individual project details or contact us for specific information.' },
    { q: 'How long do projects typically take to complete?', a: 'Project timelines range from 18 to 36 months depending on the scope and complexity. Refer to individual project pages for specific timelines.' },
    { q: 'Are there different payment plans available?', a: 'Yes, we offer flexible construction-linked payment plans. Visit our payment plans page or contact us to discuss options.' },
    { q: 'What documentation is required for investment?', a: 'We require standard KYC documentation and investment agreements. Our team will guide you through the complete process.' },
  ];
      ...
      <main className="min-h-screen bg-[#F8F4EF]">
        ...
        <section className="bg-[#1A1A2E] py-4">
          <div className="max-w-7xl mx-auto px-4 md:px-6 text-center">
            <p className="font-sans text-sm text-white/80">Every enquiry receives a response within 2 hours. Monday to Saturday, 9AM to 6PM.</p>
          </div>
        </section>
              ...
              {contactMethods.map((method) => {
                ...
                return (
                  <div key={method.title}>
                    <a href={method.href} target={method.title === 'Address' ? '_blank' : undefined} rel={method.title === 'Address' ? 'noopener noreferrer' : undefined} className="group cursor-pointer">
        ...
        {/* Contact Form */}
        <section id="site-visit" className="py-12 md:py-20 bg-muted/30 border-t border-border">
        ...
        <section className="py-12 md:py-20">
          <div className="max-w-4xl mx-auto px-4 md:px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-12 mt-4">Frequently Asked Questions</h2>
